...
./build/install/sbk/bin/sbk -class minio -writers 1 -size 100 \
  -seconds 60 \
  -csvfile samples/charts/openio-minio/minio_write_benchmarks.csv

# MinIO read
./build/install/sbk/bin/sbk -class minio -readers 1 -size 100 \
  -seconds 60 \
  -csvfile samples/charts/openio-minio/minio_read_benchmarks.csv
```
...
./build/install/sbk/bin/sbk -class openio -url http://127.0.0.1:6007 \
  ...
  -csvfile samples/charts/openio-minio/OpenIO_write_benchmarks.csv

# OpenIO read
./build/install/sbk/bin/sbk -class openio -url http://127.0.0.1:6007 \
  -readers 1 -size 100 -seconds 60 \
  -csvfile samples/charts/openio-minio/OpenIO_read_benchmarks.csv
```
